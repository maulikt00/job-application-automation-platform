...
334 tests, covering domain models, configuration/logging, the database
...
recommendations, and the opening website connector interface plus its
first concrete implementation (`GreenhouseConnector`, verified against
real Chromium and grounded in Greenhouse's own published documentation).
